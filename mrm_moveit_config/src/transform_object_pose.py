...
import rospy
from mrm_moveit_config.msg import mrmCameraImage
import tf2_ros
...
def logical_camera_callback(data):
  ...
  if (data.models[-1].type == 'ar_pose_marker'):
...
if __name__== '__main__':
  ...
  rospy.Subscriber('/sricam/left/image_raw', mrmCameraImage, logical_camera_callback)
